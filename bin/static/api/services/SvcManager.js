...
var SvcManager = function (_Events$EventEmitter) {
  _inherits(SvcManager, _Events$EventEmitter);
  ...
  function SvcManager() {
    ...
    var _this = _possibleConstructorReturn(this, (SvcManager.__proto__ || Object.getPrototypeOf(SvcManager)).call(this));
